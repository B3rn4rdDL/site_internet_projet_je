...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $req = $bdd->query('SELECT nom, prix, descriptif, lien_img FROM liste_produits WHERE id="11"');  // Requête pour récupérer les données du produit dont l'id est égal à 11
