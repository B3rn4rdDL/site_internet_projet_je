...
<html>
    ...
    <body>
        ...
        <?php
            ...
            $req = $bdd->query('SELECT nom, prix, descriptif, lien_img FROM liste_produits WHERE id="10"'); // Requête pour récupérer les données du produit dont l'id est égal à 10
            if($donnees = $req->fetch())
            {
                ...
                $image = $donnees['lien_img']; // On affiche toutes ces données sous forme de tableau
            }
